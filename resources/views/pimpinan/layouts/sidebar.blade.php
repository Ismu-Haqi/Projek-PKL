@php
    // Helper untuk menentukan rute yang sedang aktif di grup 'pimpinan.'
    $currentRoute = Request::routeIs('pimpinan.*') ? Request::route()->getName() : '';
    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="space-y-1 sidebar-menu">
            ...
            <a href="{{ route('pimpinan.dashboard') }}" 
               class="sidebar-link {{ $isActive('pimpinan.dashboard') }}">
