    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <a href="{{ route('pimpinan.mutasi.download-ba', $mutation->id) }}"
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow p-5">
                ...
                <form method="POST" action="{{ route('pimpinan.mutasi.approve', $mutation->id) }}" class="mb-3">
                    @csrf
                    <button type="submit"
            ...
            <div class="bg-white rounded-xl shadow p-5 space-y-3">
                ...
                <form method="POST" action="{{ route('pimpinan.mutasi.destroy', $mutation->id) }}">
                    @csrf @method('DELETE')
                    <button type="submit"
...
<div id="rejectModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-md mx-4 p-6">
        ...
        <form method="POST" action="{{ route('pimpinan.mutasi.reject', $mutation->id) }}">
            @csrf
