...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    ...
    <!-- Form -->
    <form action="{{ route('pimpinan.aset.update', $asset->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
    ...
    <form id="deleteForm" action="{{ route('pimpinan.aset.destroy', $asset->id) }}" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
