...
<div class="p-6">
    ...
    {{-- Filter Section --}}
    <form action="{{ route('pimpinan.aset.index') }}" method="GET" class="bg-white p-4 rounded-lg shadow mb-6">
        <div class="grid grid-cols-1 md:grid-cols-6 gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('pimpinan.aset.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
            ...
            <div class="p-4">
                ...
                <div class="pt-3 border-t border-gray-100 space-y-2">
                    ...
                    <a href="{{ route('pimpinan.aset.show', $asset->id) }}" 
