...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div class="flex gap-2">
            <form action="{{ route('pimpinan.notifikasi.read-all') }}" method="POST" class="inline" id="markAllReadForm">
                @csrf
            ...
            <form action="{{ route('pimpinan.notifikasi.index') }}" method="GET" class="inline" id="clearReadForm">
            ...
            <div class="ml-4 flex-1">
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2 ml-4">
                        @if($notification->url)
                        <a href="{{ route('pimpinan.notifikasi.read', $notification->id) }}" 
                        ...
                        @if(!$notification->isRead())
                        <form action="{{ route('pimpinan.notifikasi.read', $notification->id) }}" method="POST" class="inline">
                            @csrf
                        ...
                        <form action="{{ route('pimpinan.notifikasi.destroy', $notification->id) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
