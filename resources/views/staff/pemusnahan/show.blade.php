    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-xl shadow p-6">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100">
                    <a href="{{ route('staff.pemusnahan.download-ba', $destruction->id) }}"
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-xl shadow p-5 space-y-3">
                ...
                <form method="POST" action="{{ route('staff.pemusnahan.destroy', $destruction->id) }}">
                    @csrf @method('DELETE')
                    <button type="submit"
                            onclick="return confirm('Batalkan usulan pemusnahan ini?')"
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-xs text-yellow-800">
                Usulan ini masih menunggu persetujuan Admin. Berita Acara akan tersedia otomatis setelah disetujui.
            </div>
            @endif
        </div>
    </div>
