...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            <a href="{{ route('staff.disposisi.show', $disposition->id) }}" class="mr-4 p-2 hover:bg-gray-100 rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form action="{{ route('staff.disposisi.update', $disposition->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
