...
{{-- NOTE: Staff menggunakan layout yang sama dengan Admin, tetapi link di sidebar berbeda. --}}
...
<div class="p-6">
    ...
    <div class="bg-yellow-500 p-6 rounded-lg text-white mb-6">
        <h1 class="text-2xl font-bold mb-1">Selamat Datang, {{ Auth::user()->role ?? 'Staff' }}!</h1>
