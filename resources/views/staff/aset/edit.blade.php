...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    ...
    <div class="mb-6">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
            <a href="{{ route('staff.aset.index') }}" class="hover:text-blue-600">Manajemen Aset</a>
    ...
    <!-- Form -->
    <form action="{{ route('staff.aset.update', $asset->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-between items-center pt-6 border-t">
            <form action="{{ route('staff.aset.destroy', $asset->id) }}" method="POST" 
