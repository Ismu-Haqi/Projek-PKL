...
<div class="p-6">
    ...
    {{-- Daftar Arsip Favorit (Menggunakan Grid Card) --}}
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
        
        {{-- Loop untuk menampilkan data arsip favorit --}}
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-100 transition duration-300 hover:shadow-xl">
            <div class="flex justify-between items-start mb-3">
                ...
                <button class="text-yellow-500 hover:text-yellow-600 focus:outline-none ml-2">
            ...
            {{-- Nomor Dokumen --}}
            <p class="text-sm font-medium text-gray-500 mb-2">{{ $archive->nomor_dokumen }}</p>
            ...
            <div class="mb-4">
                ...
                {{-- Anda bisa menambahkan tag lain jika ada --}}
            </div>
            ...
            <div class="space-y-2 text-sm text-gray-600 border-t pt-4">
                ...
                <div class="flex items-center">
                    ...
                    <span>{{ \Carbon\Carbon::parse($archive->tanggal_dokumen)->isoFormat('D MMM YYYY') }}</span>
                </div>
                ...
                <div class="flex items-center">
                    ...
                    <span>{{ $archive->unit }} • {{ $archive->pengunggah }}</span>
                </div>
