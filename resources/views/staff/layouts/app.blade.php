        ...
        <div class="p-4">
           <div class="flex items-center mb-6 pb-4 mt-3">
            ...
            <nav>
                ...
                {{-- ============================================= --}}
                <p class="text-xs text-gray-400 font-semibold uppercase mt-4 mb-2 px-2">LAPORAN & SISTEM</p>

                {{-- Laporan --}}
                <a href="{{ route('staff.laporan.index') }}"
                   class="sidebar-link {{ Request::routeIs('staff.laporan.*') && !Request::routeIs('staff.laporan.pengajuan.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- Pengajuan TTE --}}
                <a href="{{ route('staff.laporan.pengajuan.index') }}"
                   class="sidebar-link {{ Request::routeIs('staff.laporan.pengajuan.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
