...
<body>
    ...
    <div id="main-content">
        ...
        <!-- Content -->
        <main class="p-6">
            {{-- ❌ HAPUS NOTIFIKASI LAMA - Sudah pakai Sweetalert2 --}}
            {{-- @if(session('success'))
    ...
    <!-- ✅ INCLUDE SWEETALERT PARTIAL - TAMBAHKAN INI -->
    ...
    <script>
        ...
        // ❌ HAPUS function confirmLogout() lama - Sudah ada di sweetalert.blade.php
