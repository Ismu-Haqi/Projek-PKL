...
<head>
    {{-- Appearance Settings --}}
@include('staff.layouts.appearance-styles')
    <meta charset="UTF-8">
    ...
    <aside id="sidebar">
        <div class="p-4">
            ...
            <nav>
                ...
                <a href="{{ route('staff.aset.index') }}" class="sidebar-link {{ Request::routeIs('staff.aset.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {{-- <a href="{{ route('staff.user.index') }}" class="sidebar-link {{ Request::routeIs('staff.user.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('staff.laporan.index') }}" class="sidebar-link {{ Request::routeIs('staff.laporan.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('staff.pengaturan.index') }}" class="sidebar-link {{ Request::routeIs('staff.pengaturan.*') ? 'active' : '' }}">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Bagian yang perlu diupdate di staff/layouts/app.blade.php -->
...
<div class="relative">
    <button onclick="toggleProfile()" class="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 transition-all">
        ...
        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold shadow-md overflow-hidden">
            @if(Auth::user()->avatar)
    ...
    <div id="profileDropdown" class="dropdown-menu absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50">
        <div class="p-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
            <div class="flex items-center space-x-3">
                <!-- ✅ AVATAR WITH IMAGE SUPPORT IN DROPDOWN -->
                <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white font-bold text-lg shadow-md overflow-hidden flex-shrink-0">
                    @if(Auth::user()->avatar)
                        <img src="{{ asset('storage/' . Auth::user()->avatar) }}" 
                             alt="{{ Auth::user()->name }}" 
                             class="w-full h-full object-cover">
        ...
        <div class="p-2">
            ...
            <a href="{{ route('staff.pengaturan.index') }}" class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors">
                <svg class="w-5 h-5 text-gray-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
