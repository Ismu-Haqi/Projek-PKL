...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center mb-4">
            <a href="{{ route('staff.user.show', $user->id) }}" class="mr-4 p-2 hover:bg-gray-100 rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <form action="{{ route('staff.user.update', $user->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required
                            ...
                            <option value="staff" {{ old('role', $user->role) == 'staff' ? 'selected' : '' }}>staffistrator</option>
