...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            <a href="{{ route('staff.user.index') }}" class="mr-4 p-2 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-red-200 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                        ...
                        <form action="{{ route('staff.user.toggleStatus', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin?')">
                            @csrf
                            @method('PUT')
                    ...
                    <div class="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
                        ...
                        <form action="{{ route('staff.user.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini? Tindakan ini tidak dapat dibatalkan!')">
                            @csrf
                            @method('DELETE')
...
<div id="resetPasswordModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4">
        ...
        <form action="{{ route('staff.user.reset-password', $user->id) }}" method="POST" class="p-6 space-y-4">
            @csrf
            @method('POST')
