...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Pencatatan agenda surat keluar Dinas Komunikasi dan Informatika</p>
        </div>
        <a href="{{ route('staff.surat-keluar.create') }}"
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-semibold text-gray-600">Tanggal Surat</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-gray-500 text-xs">{{ $letter->tanggal_surat->format('d M Y') }}</td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="{{ route('staff.surat-keluar.show', $letter->id) }}"
                ...
                @empty
                <tr><td colspan="6" class="px-4 py-12 text-center text-gray-400">Belum ada surat keluar tercatat.</td></tr>
                @endforelse
            </tbody>
        </table>
        @if($letters->hasPages())
