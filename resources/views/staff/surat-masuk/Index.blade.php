...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Surat masuk yang Anda input dan kelola</p>
        </div>
        <a href="{{ route('staff.surat-masuk.create') }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
            <p class="text-sm text-gray-500 font-medium">Surat Saya</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-6">
        <form method="GET" action="{{ route('staff.surat-masuk.index') }}" class="flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('staff.surat-masuk.index') }}" class="text-gray-500 px-4 py-2 rounded-lg text-sm border border-gray-300 hover:bg-gray-50 transition">
                Reset
            </a>
            @endif
        </form>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                ...
                                {{-- Hapus (hanya surat milik sendiri) --}}
                                <form action="{{ route('staff.surat-masuk.destroy', $letter->id) }}" method="POST"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center text-gray-400">
                            ...
                            <a href="{{ route('staff.surat-masuk.create') }}" class="text-blue-600 hover:underline text-sm mt-1 inline-block">
                                + Input surat pertama
                            </a>
                        </td>
                    </tr>
