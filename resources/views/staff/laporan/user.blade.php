...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="flex items-center">
            <a href="{{ route('staff.laporan.index') }}" class="mr-4 p-2 hover:bg-gray-100 rounded-lg transition-colors">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <p class="text-3xl font-bold text-purple-600">{{ $users->where('role', 'staff')->count() }}</p>
        </div>
...
<div class="flex gap-2 mb-4">
    <a href="{{ route('staff.laporan.print-pdf', ['type' => 'user']) }}" 
       target="_blank"
    ...
    <a href="{{ route('staff.laporan.export-pdf', ['type' => 'user']) }}" 
