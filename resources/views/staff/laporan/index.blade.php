        ...
        <div class="bg-white rounded-xl border-2 border-teal-300 overflow-hidden hover:shadow-lg transition-all duration-300">
            <a href="{{ route('staff.laporan.surat-keluar') }}" class="block p-5 group">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <span class="text-teal-600 font-bold text-sm bg-teal-100 px-2 py-0.5 rounded-full">08</span>
                </div>
                <h4 class="font-bold text-gray-800 mb-1">Laporan Surat Keluar</h4>
                <p class="text-xs text-gray-500">Rekap surat keluar & status TTE milik Anda</p>
            </a>
            <div class="px-5 pb-4">
                <a href="{{ route('staff.laporan.print-pdf', ['type' => 'laporan-surat-keluar']) }}" target="_blank"
                   class="flex items-center justify-center gap-1.5 w-full bg-teal-500 hover:bg-teal-600 text-white py-2 rounded-lg text-xs font-semibold transition">
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                    Lihat Laporan
                </a>
            </div>
