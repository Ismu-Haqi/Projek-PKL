...
<div class="p-6">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('staff.laporan.index') }}" class="p-2 hover:bg-gray-100 rounded-lg transition">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-center">
                        @if($p->isApproved() && $p->canDownload(Auth::id()))
                            <a href="{{ route('staff.laporan.pengajuan.download', $p->id) }}"
                        ...
                        @elseif($p->status === 'ditolak')
                            <form method="POST" action="{{ route('staff.laporan.pengajuan.ajukan-ulang', $p->id) }}">
                                @csrf
