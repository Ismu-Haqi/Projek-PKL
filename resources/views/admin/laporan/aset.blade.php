...
<div class="space-y-6">
    ...
    <!-- ✅ FIXED: Export Buttons (Print PDF & Download PDF) -->
    <div class="flex gap-2">
        <a href="{{ route(auth()->user()->role . '.laporan.print-pdf', ['type' => 'aset'] + request()->query()) }}" 
           target="_blank"
        ...
        <a href="{{ route(auth()->user()->role . '.laporan.export-pdf', ['type' => 'aset'] + request()->query()) }}" 
