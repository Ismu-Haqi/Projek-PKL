...
<div class="p-6 max-w-3xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        @if($letter->file_path)
        <div class="mt-4 pt-4 border-t border-gray-100">
            <a href="{{ route('admin.surat-keluar.download', $letter->id) }}"
        ...
        <div class="mt-6 pt-4 border-t border-gray-100">
            <a href="{{ route('admin.surat-keluar.index') }}" class="text-sm text-teal-600 hover:underline">← Kembali ke daftar</a>
        </div>
    </div>
</div>
@endsection
