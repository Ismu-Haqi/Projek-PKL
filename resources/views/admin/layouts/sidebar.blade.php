    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="space-y-1 sidebar-menu">
            ...
            <a href="{{ route('admin.arsip.index') }}" 
               class="sidebar-link {{ Request::routeIs('admin.arsip.index') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.arsip.favorit') }}" 
               class="sidebar-link {{ Request::routeIs('admin.arsip.favorit') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.disposisi.index') }}" 
               class="sidebar-link {{ Request::routeIs('admin.disposisi.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.notifikasi.index') }}" 
               class="sidebar-link {{ Request::routeIs('admin.notifikasi.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.aset.index') }}" 
               class="sidebar-link {{ Request::routeIs('admin.aset.*') ? 'active' : '' }}">
