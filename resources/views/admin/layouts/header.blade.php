...
<header class="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center space-x-3 ml-6">
            <!-- Notification Button -->
            <div class="relative">
                <button class="header-btn relative p-2.5 rounded-xl text-gray-600 hover:bg-gray-100 transition-all" id="notificationBtn" type="button">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div id="notificationDropdown" class="dropdown-menu hidden absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50">
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        <a href="{{ route(Auth::user()->role . '.notifikasi.index') }}" class="notification-item flex items-start p-4 hover:bg-gray-50 border-b border-gray-100 transition-colors">
            ...
            <!-- Profile Dropdown -->
            <div class="relative">
                <button class="profile-btn flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-100 transition-all" id="profileBtn" type="button">
                ...
                <div id="profileDropdown" class="dropdown-menu hidden absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50">
                    ...
                    <div class="p-2">
                        <a href="{{ route(Auth::user()->role . '.pengaturan.index') }}" class="profile-menu-item flex items-center px-4 py-3 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div class="p-2 border-t border-gray-200">
                        <button type="button" onclick="handleLogout()" class="logout-btn w-full flex items-center px-4 py-3 rounded-lg hover:bg-red-50 transition-colors group">
