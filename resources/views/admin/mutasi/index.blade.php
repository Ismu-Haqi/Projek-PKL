...
<div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-5">
        <form method="GET" action="{{ route('admin.mutasi.index') }}" class="flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('admin.mutasi.index') }}" class="text-gray-500 px-4 py-2 rounded-lg text-sm border hover:bg-gray-50 transition">Reset</a>
        </form>
    </div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="{{ route('admin.mutasi.show', $mutation->id) }}"
