...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Tinjau dan setujui usulan pemusnahan aset dari staff</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-4 mb-5">
        <form method="GET" action="{{ route('admin.pemusnahan.index') }}" class="flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('admin.pemusnahan.index') }}" class="text-gray-500 px-4 py-2 rounded-lg text-sm border hover:bg-gray-50 transition">Reset</a>
        </form>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-4 py-3 text-gray-600 text-xs">{{ $destruction->pengaju->name ?? '-' }}</td>
                    <td class="px-4 py-3">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="{{ route('admin.pemusnahan.show', $destruction->id) }}"
